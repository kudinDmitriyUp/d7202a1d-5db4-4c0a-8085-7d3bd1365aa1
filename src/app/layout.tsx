...
export const metadata: Metadata = {
  title: "La Stella d'Oro - Ristorante 3 Stelle Michelin Milano",
  description: "Esperienza culinaria straordinaria nel cuore di Milano. Ristorante 3 stelle Michelin con menu degustazione d'eccellenza e cantina esclusiva. Prenota ora.",
  keywords: "ristorante michelin milano, 3 stelle michelin, fine dining milano, ristorante lusso milano, menu degustazione, cucina italiana gourmet",
  metadataBase: new URL("https://lastelladoro.it"),
  alternates: {
    canonical: "https://lastelladoro.it"
  },
  openGraph: {
    title: "La Stella d'Oro - Ristorante 3 Stelle Michelin Milano",
    description: "Un'esperienza culinaria straordinaria nel cuore di Milano con 3 stelle Michelin",
    url: "https://lastelladoro.it",
    siteName: "La Stella d'Oro",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763631058279-yxwvn8uk.jpg",
        alt: "La Stella d'Oro - Ristorante di lusso Milano"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "La Stella d'Oro - Ristorante 3 Stelle Michelin Milano",
    description: "Un'esperienza culinaria straordinaria nel cuore di Milano",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763631058279-yxwvn8uk.jpg"]
  },
  robots: {
    index: true,
    follow: true
